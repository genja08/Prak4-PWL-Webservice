        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            ...
            <ul class="list-group list-group-unbordered mb-3">
              ...
              <li class="list-group-item">
                <b>Link Pinterest</b> <a class="float-right small text-dark">{{ $item->link_pinterest }}</a>
              </li>
            </ul>
          </div>
          <!-- /.card-body -->
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.pengaturan.update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="link_path">Link Pinterest</label>
                        <input type="text" name="link_pinterest" class="form-control @error('link_pinterest') is-invalid @enderror" id="link_pinterest" value="{{ $item->link_pinterest ?? old('link_pinterest') }}">
                        @error('link_pinterest')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        @enderror
